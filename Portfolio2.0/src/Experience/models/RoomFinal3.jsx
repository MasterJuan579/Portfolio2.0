...
Command: npx gltfjsx@6.5.3 RoomFinal3.glb 
*/
...
export default function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      <mesh geometry={nodes.Plane002.geometry} material={basicMaterials.AzulOscuro} position={[0, -0.2, 0]} />
...
useGLTF.preload('/RoomFinal3.glb')
